# Site-Wide Navigation Repair & Standardization Script (Ver 6 - The Sovereign Standard)
# This script synchronizes all HTML files with the Gold Standard Navigation template from index.html
