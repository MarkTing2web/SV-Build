...
edits = [
    ("portfolio/condominiums/newton21-newton-condo.html", 280, '<section class="portfolio-section sv-section-white section-spacing">', '<section class="portfolio-section sv-section-grey section-spacing">'),
    ("portfolio/condominiums/village-pasir-panjang-condo.html", 332, '<section class="portfolio-section sv-section-white section-spacing">', '<section class="portfolio-section sv-section-grey section-spacing">'),
    ("portfolio/condominiums/the-verte-telok-kurau-condo.html", 292, '<section class="portfolio-insight-section sv-section-white section-spacing no-bottom-spacing">', '<section class="portfolio-insight-section sv-section-grey section-spacing no-bottom-spacing">')
]
...
with open("sections_output_final.txt", "w", encoding="utf-8") as out:
    for fpath in files:
        full_path = os.path.join(base_dir, fpath)
