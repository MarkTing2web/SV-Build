...
for html_path in sorted(html_files):
    ...
    # Combine and deduplicate referenced files for this article
...
if not issues:
    print("✅ PART 1 ALL CLEAR — no broken or zero-byte image references found")
else:
