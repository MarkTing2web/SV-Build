"""
audit_insights_v3.py — Securevision Insights Audit Script
Scope:  /insights/*.html  (article pages + index.html hub)
Action: READ ONLY — no file modifications. Produces markdown report.
Run:    python audit_insights_v3.py
Output: insights-audit-report-v3.md  (same dir as this script, or set OUT_FILE below)
...
OUT_FILE    = r"C:\Projects\SV-Build\insights-audit-report-v3.md"
# ─────────────────────────────────────────────────────────────────────────────
...
if __name__ == "__main__":
    ...
    out.append("## Securevision SV-Web · Generated by audit_insights_v3.py")
    out.append("")
    ...
    out.append("---")
    out.append("")
    out.append("*Securevision · Insights Audit · v3.0 · June 2026*")
