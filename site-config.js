...
SECUREVISION.portfolio = [
  ...
  { url: "/portfolio/industrial/cyrus-tech-industrial", title: "Cyrus Tech", section: "Portfolio · Industrial", excerpt: "Industrial security upgrade at Loyang — access control and surveillance for a technology facility.", tags: ["access-control", "cctv", "industrial", "loyang"] },
...
SECUREVISION.guides = [
  { slug: "auto-gate-guide", category: "Vehicle & Gates", url: "/resources/guides/auto-gate-guide", title: "Auto Gate Guide", section: "Resources · Guides", excerpt: "How auto gate systems work, motor types, safety requirements, and what to specify for your property.", tags: ["auto-gate", "motor", "residential", "guide", "singapore"] },
  { slug: "burglar-alarm-guide", category: "Alarm & Intrusion", url: "/resources/guides/burglar-alarm-guide", title: "Burglar Alarm Guide", section: "Resources · Guides", excerpt: "How burglar alarm systems work, zone design, detector types, monitoring options, and Singapore regulations.", tags: ["burglar-alarm", "guide", "zones", "monitoring", "singapore"] },
  { slug: "car-park-barrier-guide", category: "Vehicle & Gates", url: "/resources/guides/car-park-barrier-guide", title: "Car Park Barrier Guide", section: "Resources · Guides", excerpt: "LPR barriers, boom gates, RFID, and vehicle management systems for Singapore car parks.", tags: ["lpr", "barrier", "car-park", "vehicle", "guide", "singapore"] },
  { slug: "cctv-guide", category: "CCTV & Surveillance", url: "/resources/guides/cctv-guide", title: "CCTV Guide", section: "Resources · Guides", excerpt: "IP cameras, resolution, storage, NVR selection, night vision, analytics, PDPA compliance, and brand evaluation.", tags: ["cctv", "nvr", "ip", "resolution", "guide", "singapore", "pdpa"] },
  { slug: "door-access-guide", category: "Access Control", url: "/resources/guides/door-access-guide", title: "Door Access Control Guide", section: "Resources · Guides", excerpt: "Card access, biometrics, face recognition, door controllers, and access management for Singapore buildings.", tags: ["access-control", "biometric", "card", "face-recognition", "guide", "singapore"] },
  { slug: "how-to-evaluate-security-contractor", category: "Security Planning", url: "/resources/guides/how-to-evaluate-security-contractor", title: "How to Evaluate a Security Contractor", section: "Resources · Guides", excerpt: "PLRD licensing, reading a quotation, site assessment standards, red flags, warranty terms, and correct handover.", tags: ["contractor", "plrd", "quotation", "evaluation", "guide", "singapore"] },
  { slug: "intercom-guide", category: "Access & Intercom", url: "/resources/guides/intercom-guide", title: "Intercom Systems Guide", section: "Resources · Guides", excerpt: "Analogue vs IP, 2-wire retrofit, cloud platforms, door release, lift integration, and mobile app considerations.", tags: ["intercom", "ip", "2-wire", "mobile", "guide", "singapore", "akuvox"] },
  { slug: "office-telephone-guide", category: "IP Telephony", url: "/resources/guides/office-telephone-guide", title: "IP Telephony Guide", section: "Resources · Guides", excerpt: "IP desk phones, IPPBX systems, SIP protocols, and how to replace legacy keyphone systems in Singapore offices.", tags: ["ip-phone", "ippbx", "sip", "telephony", "guide", "singapore"] },
  { slug: "security-renovation-guide", category: "Security Planning", url: "/resources/guides/security-renovation-guide", title: "Security Planning During Renovation", section: "Resources · Guides", excerpt: "Conduit routes, M&E coordination, and what retrofitting costs later — for Singapore BTO, resale, and commercial renovations.", tags: ["renovation", "conduit", "cabling", "guide", "singapore", "bto"] },
  { slug: "wifi-network-guide", category: "Network", url: "/resources/guides/wifi-network-guide", title: "Network & Wi-Fi Guide", section: "Resources · Guides", excerpt: "Managed switches, PoE, Wi-Fi access points, and network infrastructure for security systems in Singapore.", tags: ["network", "wifi", "poe", "switches", "guide", "singapore"] },
];
