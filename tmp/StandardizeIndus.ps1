$file = "c:\Users\ler\OneDrive - Securevision Pte Ltd\1 SV Build\industrial-security-singapore.html"
$content = Get-Content $file -Raw

# 1. Hero Standardisation
# Replace hero section opening tag
$content = $content -replace '<section class="hero-industrial hero" style="[^"]+">', "<section class='hero-industrial hero hero-indus'>"
...
# 2. Hero Buttons
$content = $content -replace 'Request Engineering Audit', 'Book Site Assessment'

# 3. Final CTA Block
$content = $content -replace '<section id="final-cta" class="cta-section" style="[^"]+">', '<section id="final-cta" class="cta-high-impact cta-indus">'
...
# Wrap buttons in mt-48 (keeping hrefs consistent)
...
# Update the assessment link with intent parameter
$content = $content -replace '<a href="request-site-assessment-singapore\.html" class="btn btn-primary">Book Site Assessment</a>', '<div class="mt-48"><a href="request-site-assessment-singapore.html?intent=industrial-assessment" class="btn btn-primary">Book Site Assessment</a></div>'
