...
const staticPages = [
  ...
  { url: '/solutions/residential.html',      title: 'Residential Security',        section: 'Solutions', excerpt: 'CCTV, burglar alarm, video intercom, auto gate, and access control for landed homes in Singapore.' },
  { url: '/solutions/condominiums.html',     title: 'Condominium Security',        section: 'Solutions', excerpt: 'Intercom upgrades, LPR vehicle management, access control, and estate-wide CCTV for Singapore condominiums and MCSTs.' },
  { url: '/solutions/commercial.html',       title: 'Commercial Security',         section: 'Solutions', excerpt: 'Access control, CCTV, IP telephony, and visitor management for Singapore offices, hotels, and commercial buildings.' },
  { url: '/solutions/industrial.html',       title: 'Industrial Security',         section: 'Solutions', excerpt: 'Perimeter CCTV, LPR vehicle barriers, access control, and alarm systems for Singapore factories and warehouses.' },
  { url: '/solutions/institutions.html',     title: 'Institutional Security',      section: 'Solutions', excerpt: 'Security systems for schools, government offices, and civic facilities in Singapore.' },
  { url: '/solutions/healthcare.html',       title: 'Healthcare Security',         section: 'Solutions', excerpt: 'Access control and surveillance for nursing homes, day care centres, and care facilities in Singapore.' },
  { url: '/solutions/managed-living.html',   title: 'Managed Living Security',     section: 'Solutions', excerpt: 'Security systems for worker dormitories and co-living properties — MOM compliance and resident management.' },
  { url: '/solutions/data-centres.html',     title: 'Data Centre Security',        section: 'Solutions', excerpt: 'Tiered access control, biometric verification, and comprehensive CCTV for Singapore data centres.' },
  // Systems
